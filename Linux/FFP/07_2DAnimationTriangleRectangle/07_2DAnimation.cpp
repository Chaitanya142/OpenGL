...
static GLfloat angle_Trianlge = 0.0f;
	static GLfloat angle_Rectangle = 0.0f;
	
	void DrawFilledTriangle(float offset);
	void DrawFilledRectangle(float offset);
	...
	glLoadIdentity();
	glTranslatef(1.5f, 0.0f, -6.0f);
	glRotatef(angle_Rectangle, 1.0f, 0.0f, 0.0f);
	DrawFilledRectangle(1.0f);

	glXSwapBuffers(gpDisplay,gWindow);

    angle_Trianlge = angle_Trianlge + 0.3f;
