...
int day = 0;
int moon = 0;
GLUquadric *gluQuadric_Earth = NULL;
GLUquadric *gluQuadric_Sun = NULL;
GLUquadric *gluQuadric_Moon = NULL;
...
void Display(void) {
	...
	gluQuadric_Sun = gluNewQuadric();
	glColor3f(1.0f, 1.0f, 1.0f);
	gluSphere(gluQuadric_Sun, 0.75f, 30, 30);
	glPopMatrix();

	glPushMatrix();
	glRotatef((GLfloat)year, 0.0f, 1.0f, 0.0f);
	glTranslatef(2.0f, 0.0f, 0.0f);
	glRotatef(90.0f, 1.0f, 0.0f, 0.0f);//To change axis of Sphere model 
	glRotatef((GLfloat)day, 0.0f, 0.0f, 1.0f);
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	gluQuadric_Earth = gluNewQuadric();
	glColor3f(0.4f, 0.9f, 1.0f);
	gluSphere(gluQuadric_Earth, 0.2f, 20, 20);
	...
	//glRotatef(90.0f, 1.0f, 0.0f, 0.0f);
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	gluQuadric_Moon = gluNewQuadric();
	glColor3f(0.5f, 0.5f, 0.5f);
	gluSphere(gluQuadric_Moon, 0.1f, 15, 15);
...
void UnInitialize(void) {
	...
	if (gluQuadric_Earth) {
		gluDeleteQuadric(gluQuadric_Earth);
	}
	if (gluQuadric_Sun) {
		gluDeleteQuadric(gluQuadric_Sun);
	}
}
