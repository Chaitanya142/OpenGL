...
D3D11_VIEWPORT d3dViewPort;
void DrawSphere(XMMATRIX &worldMatrix, XMMATRIX &scaleMatrix, XMMATRIX &rotationMatrix, XMMATRIX &translationMatrix, XMMATRIX &viewMatrix, CBUFFER &constantBuffer);
void display(void)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////
	d3dViewPort.TopLeftX = gWidth * (-0.45f);
	d3dViewPort.TopLeftY = gHeight * (-0.35f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
	d3dViewPort.MaxDepth = 1.0f;
	gpID3D11DeviceContext->RSSetViewports(1, &d3dViewPort);
	...
	DrawSphere(worldMatrix, scaleMatrix, rotationMatrix, translationMatrix, viewMatrix, constantBuffer);

	/////////////////////////////////////////////////////////////////////////////////////////////

	d3dViewPort.TopLeftX = gWidth * (-0.45f);
	d3dViewPort.TopLeftY = gHeight * (-0.20f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
	d3dViewPort.MaxDepth = 1.0f;
	...
	d3dViewPort.TopLeftX = gWidth * (-0.45f);
	d3dViewPort.TopLeftY = gHeight * (-0.05f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
	d3dViewPort.MaxDepth = 1.0f;
	...
	d3dViewPort.TopLeftX = gWidth * (-0.45f);
	d3dViewPort.TopLeftY = gHeight * (0.10f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
	d3dViewPort.MaxDepth = 1.0f;
	...
	d3dViewPort.TopLeftX = gWidth * (-0.45f);
	d3dViewPort.TopLeftY = gHeight * (0.25f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
	d3dViewPort.MaxDepth = 1.0f;
	...
	d3dViewPort.TopLeftX = gWidth * (-0.45f);
	d3dViewPort.TopLeftY = gHeight * (0.40f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
	d3dViewPort.MaxDepth = 1.0f;
	...
	d3dViewPort.TopLeftX = gWidth * (-0.15f);
	d3dViewPort.TopLeftY = gHeight * (-0.35f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
	...
	d3dViewPort.TopLeftX = gWidth * (0.40f);
	d3dViewPort.TopLeftY = gHeight * (-0.35f);
	d3dViewPort.Width = (float)gWidth;
	d3dViewPort.Height = (float)gHeight;
	d3dViewPort.MinDepth = 0.0f;
...
void update() {
	angleRotation = angleRotation + 0.001f;
