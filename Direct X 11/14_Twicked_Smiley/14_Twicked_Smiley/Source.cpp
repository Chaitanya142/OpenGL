...
HRESULT initialize() {
	...
	bufferDescPosition.ByteWidth = sizeof(float)*ARRAYSIZE(vertices_Rectangle);
...
void display(void)
{
	...
	if (keyPressed == 1)
	{
		...
		texcoord_Rectangle[1] = 0.5f;
		texcoord_Rectangle[2] = 0.5f;
		texcoord_Rectangle[3] = 0.5f;
		texcoord_Rectangle[4] = 0.0f;
		texcoord_Rectangle[5] = 1.0f;

		texcoord_Rectangle[6] = 0.0f;
		texcoord_Rectangle[7] = 1.0f;
		texcoord_Rectangle[8] = 0.5f;
		texcoord_Rectangle[9] = 0.5f;
		texcoord_Rectangle[10] = 0.5f;
	...
	else if (keyPressed == 3)
	{
		texcoord_Rectangle[0] = 0.0f;
		texcoord_Rectangle[1] = 0.0f;
		texcoord_Rectangle[2] = 2.0f;
		texcoord_Rectangle[3] = 0.0f;
		texcoord_Rectangle[4] = 0.0f;
		texcoord_Rectangle[5] = 2.0f;

		texcoord_Rectangle[6] = 0.0f;
		texcoord_Rectangle[7] = 2.0f;
		texcoord_Rectangle[8] = 2.0f;
		texcoord_Rectangle[9] = 0.0f;
		texcoord_Rectangle[10] = 2.0f;
		texcoord_Rectangle[11] = 2.0f;
	}
	else if (keyPressed == 4)
	{
		texcoord_Rectangle[0] = 0.5f;
		texcoord_Rectangle[1] = 0.5f;
		texcoord_Rectangle[2] = 0.5f;
		texcoord_Rectangle[3] = 0.5f;
		texcoord_Rectangle[4] = 0.5f;
		texcoord_Rectangle[5] = 0.5f;

		texcoord_Rectangle[6] = 0.5f;
		texcoord_Rectangle[7] = 0.5f;
		texcoord_Rectangle[8] = 0.5f;
		texcoord_Rectangle[9] = 0.5f;
		texcoord_Rectangle[10] = 0.5f;
		texcoord_Rectangle[11] = 0.5f;
	}
	else
	{
		texcoord_Rectangle[0] = 0.0f;
...
/*
	if (keyPressed == 1) {
		...
		texcoord_Rectangle[4] = 0.5f;
		texcoord_Rectangle[3] = 0.5f;
		texcoord_Rectangle[5] = 0.0f;
		texcoord_Rectangle[6] = 0.5f;
		texcoord_Rectangle[7] = 0.0f;
		texcoord_Rectangle[8] = 0.0f;
		texcoord_Rectangle[9] = 0.5f;
		texcoord_Rectangle[10] = 0.5f;
		texcoord_Rectangle[11] = 0.5f;
	}
		...
		texcoord_Rectangle[0] = 0.0f;
		texcoord_Rectangle[1] = 0.0f;
		texcoord_Rectangle[2] = 0.0f;
		texcoord_Rectangle[3] = 1.0f;
		texcoord_Rectangle[4] = 1.0f;
		texcoord_Rectangle[5] = 0.0f;
		texcoord_Rectangle[6] = 1.0f;
		texcoord_Rectangle[7] = 0.0f;
		texcoord_Rectangle[8] = 0.0f;
		texcoord_Rectangle[9] = 1.0f;
		texcoord_Rectangle[10] = 1.0f;
		texcoord_Rectangle[11] = 1.0f;
	}
	else if (keyPressed == 3) {
		...
		texcoord_Rectangle[1] = 0.0f;
		texcoord_Rectangle[2] = 0.0f;
		texcoord_Rectangle[3] = 2.0f;
		texcoord_Rectangle[4] = 2.0f;
		texcoord_Rectangle[5] = 0.0f;
		texcoord_Rectangle[6] = 2.0f;
		texcoord_Rectangle[7] = 0.0f;
		texcoord_Rectangle[8] = 0.0f;
		texcoord_Rectangle[9] = 2.0f;
		texcoord_Rectangle[10] = 2.0f;
		texcoord_Rectangle[11] = 2.0f;
	}
	else if (keyPressed == 4) {
