...
var lightAmbient=new Float32Array(4*3);
var lightDiffuse=new Float32Array(4*3);
var lightSpecular=new Float32Array(4*3);
var lightPosition=new Float32Array(4*3);

var arrayAmbient=new Float32Array(3*3);
var arrayDiffuse=new Float32Array(3*3);
var arraySpecular=new Float32Array(3*3);
var arrayPosition=new Float32Array(4*3);
...
function init() {
	...
	lightAmbient[3+3] = 1.0;
				
	lightDiffuse[0+3] = 0.0;
	lightDiffuse[1+3] = 1.0;
	lightDiffuse[2+3] = 0.0;
	lightDiffuse[3+3] = 1.0;

	lightSpecular[0+3] = 0.0;
	lightSpecular[1+3] = 1.0;
	lightSpecular[2+3] = 0.0;
	...
	lightAmbient[0+7] = 0.0;
	lightAmbient[1+7] = 0.0;
	lightAmbient[2+7] = 0.0;
	lightAmbient[3+7] = 1.0;
				
	lightDiffuse[0+7] = 0.0;
	lightDiffuse[1+7] = 0.0;
	lightDiffuse[2+7] = 1.0;
	lightDiffuse[3+7] = 1.0;

	lightSpecular[0+7] = 0.0;
	lightSpecular[1+7] = 0.0;
	lightSpecular[2+7] = 1.0;
	lightSpecular[3+7] = 1.0;
				 
	lightPosition[0+7] = 0.0;
	lightPosition[1+7] = 0.0;
	lightPosition[2+7] = 0.0;
	lightPosition[3+7] = 1.0;
    ...
    arrayPosition[8] = 0.0;
    arrayPosition[9] = 0.0;
    arrayPosition[10] = 0.0;
    arrayPosition[11] = 1.0;
...
function draw() {
    ...
    if (gb_Lighting) {
                ...
                gl.uniform3fv(ldUniform, arrayDiffuse);
                gl.uniform3fv(laUniform, arrayAmbient);
                gl.uniform3fv(lsUniform, arraySpecular);
                ...
                gl.uniform4fv(lightPositionUniform, arrayPosition);
...
function Update(){
    ...
    anglelightpos = anglelightpos + 0.01;
		if (anglelightpos > 2 * 3.14159265)
			anglelightpos = 0.0;

			arrayPosition[1] = (100 * Math.sin(anglelightpos));
			arrayPosition[2] = (100 * Math.cos(anglelightpos));

			arrayPosition[4] = (100 * Math.sin(anglelightpos));
			arrayPosition[6] = (100 * Math.cos(anglelightpos));

			arrayPosition[8] = (100 * Math.sin(anglelightpos));
			arrayPosition[9] = (100 * Math.cos(anglelightpos));
}
