...
function makeSphere(sphereMesh, fRadius, iSlices, iStacks,r,g,b,cx=0, cy=0) {
    // code
    ...
    for (i = 0; i < iStacks; i++) {
        ...
        var color = new Array(4); // 4 rows
        for (var a = 0; a < 4; a++)
            color[a] = new Array(3); // 3 columns
