...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
	...
	Elbow.setTextureColor(0.5f*255.0f, 0.35f*255.0f, 0.05f * 255.0f);
	Elbow.set(0.5f, 10, 10);
	
	Shoulder.glesview=this;
	Shoulder.setTextureColor(0.5f*255.0f, 0.35f*255.0f, 0.05f * 255.0f);
	Shoulder.set(0.5f, 10, 10);
	// Shoulder.glesview=this;
	// Shoulder.setTextureColor(0.5f, 10f, 10f);
	// Shoulder.set(0.75f, 30, 30);
