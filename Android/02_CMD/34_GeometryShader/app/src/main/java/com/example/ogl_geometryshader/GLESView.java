package com.example.ogl_geometryshader;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	//Fragement Shader
		...
		//Vertex Shader Code
		final String gGeometryShaderSourceCode=String.format(
			"#version 320 es" +
			"\n " +
		"layout(triangles)in;"+
		...
		//Shader object and source code mapping
		GLES32.glShaderSource(gGeometryShaderObject,
		gGeometryShaderSourceCode);
		...
		GLES32.glGetShaderiv(gGeometryShaderObject, GLES32.GL_COMPILE_STATUS, 
							iShaderCompileStatus,0);
	
		if (iShaderCompileStatus[0] == GLES32.GL_FALSE) {
			
			GLES32.glGetShaderiv(gGeometryShaderObject, GLES32.GL_INFO_LOG_LENGTH, 
								iInfoLogLength,0);
			...
			if (iInfoLogLength[0] > 0) {
					...
					System.out.println("RTR : gGeometryShaderObject"+szInfoLog);
					UnInitialize();
					System.exit(0);			
			}
		}
