...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener,ITexture {
	...
	int[] texture_Sun = new int[1];
	int[] texture_Earth = new int[1];
	int[] texture_Moon = new int[1];
	...
	texture_Sun[0]=LoadTexture(R.raw.sun);
	Sun.extTexture=true;
	setTexture(texture_Sun);
	//Sun.extTexture = true;
	//Sun.glesview=this;
	...
	//Earth.glesview=this;
	texture_Earth[0]=LoadTexture(R.raw.earth);
	Earth.extTexture=true;
	setTexture(texture_Earth);
	...
	//Moon.glesview=this;
	texture_Moon[0]=LoadTexture(R.raw.moon);
