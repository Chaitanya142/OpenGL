package com.example.ogl_perspective;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void Display() {
		...
		0.0f,0.0f,-6.0f);//https://developer.android.com/reference/android/opengl/Matrix#translateM(float%5B%5D,%20int,%20float,%20float,%20float)
