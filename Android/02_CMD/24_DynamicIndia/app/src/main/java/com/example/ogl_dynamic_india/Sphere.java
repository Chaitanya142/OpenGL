    ...
    void buildVerticesSmooth()
{
	...
	for (Integer i = 0; i <= stackCount; ++i)
	{
		...
		for (Integer j = 0; j <= sectorCount; ++j)
		{
			...
			// vertex position
			x = xy * (float)java.lang.Math.cos((double)sectorAngle)+cx;             // r * (float)java.lang.Math.cos((double)u) * (float)java.lang.Math.cos((double)v)
			y = xy * (float)java.lang.Math.sin((double)sectorAngle)+cy;             // r * (float)java.lang.Math.cos((double)u) * (float)java.lang.Math.sin((double)v)
			addVertex(x, y, z);
